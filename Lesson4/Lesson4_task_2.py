...
class NetworkAuthorize:
    ...
    def registration(self):
        ...
        while flag_log == 1:
            ...
            if login in self.logins_net.keys():
        ...
        NetworkAuthorize.logins_net.update(temp_dict)
    ...
    def authontification(self):
        ...
        if login in self.logins_net.keys():
            ...
            if password == self.logins_net[login]['password']:
                return login, 1
            else:
...
class Post(NetworkAuthorize):
    #time_of_create = str(datetime.now())[:-7]
        ...
        if temp == 1:
            ...
            while flag2 == 1:
                ...
                if answer2 == '1':
                    ...
                    print(NetworkAuthorize.logins_net[login]['users'].chec_admin())
                    if NetworkAuthorize.logins_net[login]['users'].chec_admin() == 1:
                        print('proof')
                        for i in NetworkAuthorize.logins_net.values():
                            print(i['users'].view())
                            for j in NetworkAuthorize.logins_net[login]['posts']:
                                print(j.view_post())
                    else:
...
# u = UserNetwork()
#
# # login, password = u.registration()
# #
# # u = UserNetwork()
# # u.create_user_network(login, password)
# # print(NetworkAuthorize.logins_net)
# # print(NetworkAuthorize.logins_net[login]['users'].view())
#
#
# u.create_user_network(login, password)
# print(NetworkAuthorize.logins_net)
...
# u.create_user_post(login)
# print(NetworkAuthorize.logins_net)
# for i in NetworkAuthorize.logins_net[login]['posts']:
#     print(i.view())
# # user = UserNetwork('admin')
# # user.registration()
# # print(NetworkAuthorize.logins_net)
# # print(user.authontification())
# # print(user.time_of_create)
